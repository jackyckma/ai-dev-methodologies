...
| [portfolio-hub-reporting.md](instructions/portfolio-hub-reporting.md) | Optional six-section report contract for portfolio hubs ([schema](templates/docs/autopilot/report.schema.json)) |
